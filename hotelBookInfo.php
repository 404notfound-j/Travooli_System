...
<div class="hotel-book-info-main">
    ...
    <div class="hotel-book-info-right">
        <div class="price-details-box">
            ...
            <div class="price-details-row"><span>Tickets (<?php echo $adult; ?> Adults, <?php echo $room; ?> Room)</span></div>
        ...
        <button class="btn btn-primary hotel-book-info-submit" style="width:100%;margin-top:24px;">Proceed to Payment</button>
    </div>
</div>
