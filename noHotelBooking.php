...
if (!isset($_SESSION['user_id'])) {
    ...
    error_log("No user session in noHotelBooking.php - redirecting to signIn.php");
    header("Location: signIn.php");
    exit();
} else {
    error_log("User session found in noHotelBooking.php - User ID: " . $_SESSION['user_id']);
}
?>
        ...
        <div class="no-booking-wrapper">
            <div class="no-booking-content">
                ...
                <div class="no-booking-text-content">
                    <h1 class="no-booking-title">You don't have any bookings or we can't access your bookings at this time. Please check back later or contact support if you need assistance with your bookings.</h1>
                </div>
            </div>
            <div class="cta-section">
                <a href="hotelBook.php" class="cta-button">Search Bookings</a>
            </div>
        </div>
    </main>
