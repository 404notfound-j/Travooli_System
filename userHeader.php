...
>>>>>>> 434e1a97e8e186338e702d97b80afddff4d48208
                ...
                <li class="nav-item profile-item">
                    <div class="profile-container" id="profile-container">
                        <?php if (!empty($userData['profile_pic'])): ?>
                            <img src="data:image/jpeg;base64,<?= base64_encode($userData['profile_pic']) ?>" alt="Profile" class="profile-picture">
                        <?php else: ?>
                    ...
                    <div class="profile-dropdown" id="profile-dropdown">
                        <div class="profile-info">
                            <?php if (!empty($userData['profile_pic'])): ?>
                                <img src="data:image/jpeg;base64,<?= base64_encode($userData['profile_pic']) ?>" alt="Profile" class="profile-dropdown-pic">
                            <?php else: ?>
