...
<body>
    ...
    <section class="ratings">
      ...
      <div class="rating-buttons">
        ...
        <button class="submit-btn" 
                data-booking-id="<?php echo htmlspecialchars($flightDetailsDB[0]['flight_booking_id']); ?>" 
                data-airline-id="<?php echo htmlspecialchars($flightDetailsDB[0]['airline_id']); ?>">
          Submit
        </button>
      </div>
    </section>
  ...
  <!-- Removing the inline script since it's now handled in flight_Complete.js -->
